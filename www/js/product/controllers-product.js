...
.controller('ProductCtrl', function(
  ...
  $scope.loadComments = function() {
    ...
    ProductComments.load($scope.status.productId).then(
      function(loadedProductComments) {
          if(loadedProductComments != null) {$scope.ProductComments = Utils.arrayValues(loadedProductComments);}
  ...
  $scope.loadRatings = function() {
    ...
    ProductRatings.load($scope.status.productId).then(
      function(loadedProductRatings) {
          if(loadedProductRatings != null) {$scope.ProductRatings = loadedProductRatings}
  ...
  $scope.addRating = function() {
    if ($scope.AuthData.hasOwnProperty('uid') && $scope.FormData.ratingValue) {
      var ratingObj = {
        timestamp:  firebase.database.ServerValue.TIMESTAMP,
